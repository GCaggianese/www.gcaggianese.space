...
This repository contains both original work and modified upstream code.

* Files written specifically for this project (`agent.d`, `parser.d`, scripts, README, etc.) are licensed under Apache-2.0.
* The bundled `termrex` upstream code and any modifications derived from it remain under the original MIT license from SATYADAHAL/termrex.
...
All source files carry SPDX headers and the repository is [REUSE](https://reuse.software/)-compliant.
